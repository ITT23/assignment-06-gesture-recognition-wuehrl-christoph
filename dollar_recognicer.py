# this is an implementation of the $1 recognizer
# the hole code is heavily based on https://depts.washington.edu/acelab/proj/dollar/dollar.js
import math
import time


# classes used by the recognizer

# This class is used for the recognition process. Coordinates used for prediction should always be transformed to representations of this point class
class Point:
...
# Class to transform the points of a gesture
class Unistroke:
    def __init__(self, name, points):
        self.name = name
        self.points = resample_points(points, NUM_POINTS)
...
# class that represents the results of the recognition process
class Results:
    def __init__(self, name, score, s):
        self.name = name
        self.score = score
        self.s = s
...
ANGLE_RANGE = 45.0 * math.pi / 180.0
ANGLE_PRECISION = 2.0 * math.pi / 180.0
PHI = 0.5 * (-1.0 + math.sqrt(5.0))
HIGH_VALUE = 10000000

# The Recognizer itself
class Dollar_Recognizer:
    def __init__(self, number_of_gestures):
        # In this part the blueprints of the gestures are set
        # Here are the 3 different blueprints for the application of this assignment (media controller only needs 3 gestures, recognizer 5 and the notebook all 16)
        # The 16 gestures for the notebook are named slightly different to the ones from the website and zig-zag is changed for question mark because that is the data in the provided dataset
        # For the question mark gesture I used a example form the training dataset
        self.unistrokes = []
        if(number_of_gestures == 3):
            ...
            self.unistrokes.append(Unistroke("caret", [ Point(79,245), Point(79,242), Point(79,239), Point(80,237), Point(80,234), Point(81,232), Point(82,230), Point(84,224), Point(86,220), Point(86,218), Point(87,216), Point(88,213), Point(90,207), Point(91,202), Point(92,200), Point(93,194), Point(94,192), Point(96,189), Point(97,186), Point(100,179), Point(102,173), Point(105,165), Point(107,160), Point(109,158), Point(112,151), Point(115,144), Point(117,139), Point(119,136), Point(119,134), Point(120,132), Point(121,129), Point(122,127), Point(124,125), Point(126,124), Point(129,125), Point(131,127), Point(132,130), Point(136,139), Point(141,154), Point(145,166), Point(151,182), Point(156,193), Point(157,196), Point(161,209), Point(162,211), Point(167,223), Point(169,229), Point(170,231), Point(173,237), Point(176,242), Point(177,244), Point(179,250), Point(181,255), Point(182,257)]))
            self.unistrokes.append(Unistroke("question_mark", [ Point(95, 149),Point(94, 147),Point(95, 145),Point(96, 142),Point(97, 140),Point(98, 138),Point(100, 136),Point(102, 135),Point(104, 134),Point(105, 132),Point(107, 131),Point(109, 130),Point(111, 129),Point(114, 129),Point(116, 128),Point(118, 128),Point(120, 128),Point(122, 127),Point(124, 128),Point(126, 127),Point(128, 128),Point(130, 128),Point(132, 128),Point(134, 130),Point(136, 130),Point(138, 132),Point(140, 134),Point(142, 136),Point(144, 138),Point(145, 141),Point(145, 143),Point(145, 145),Point(145, 148),Point(145, 150),Point(146, 152),Point(146, 154),Point(146, 156),Point(146, 159),Point(146, 161),Point(146, 163),Point(145 ,165),Point(145, 167),Point(145, 170),Point(144, 172),Point(143, 175),Point(142, 177),Point(141, 179),Point(140, 181),Point(138, 184),Point(136, 185),Point(134, 186),Point(133, 188),Point(130, 189),Point(128, 190),Point(126, 191),Point(124, 193),Point(122, 192),Point(120, 194),Point(118, 195),Point(116, 194),Point(114, 195),Point(112, 196),Point(110, 197),Point(108, 198),Point(107, 200),Point(105, 202),Point(103, 204),Point(103, 206),Point(102, 208),Point(102, 211),Point(102, 213),Point(102, 215),Point(103, 217),Point(103, 219)]))
    ...
    # This function should be called for recognition. It returns the results in a Results-class
    def recognize(self, points):
        t0 = time.time()
        candidate = Unistroke('', points)

        u = -1
        # needs to be initialized with a very high value
        b = HIGH_VALUE
        counter = 0
        for unistroke in self.unistrokes:
            distance = 0
            distance= distance_at_best_angle(candidate.points, unistroke, -ANGLE_RANGE, +ANGLE_RANGE, ANGLE_PRECISION)
            if(distance < b):
                b = distance
                u = counter
            counter += 1
        t1 = time.time()
        if u == -1:
            result = Results("No match.", 0.0, t1 - t0)
        else:
            score = 1.0 - b / HALF_DIAGONAL

            result = Results(self.unistrokes[u].name, score, t1 - t0)
        return result

# resample the number of points that they have all the same length
def resample_points(points, n):
    I = path_length(points) / float(n - 1)
    D = 0.0
    new_points = [points[0]]
...
# used to calculate the distance in the recognize method 
...
# helper function for the distance at best angle method
def distance_at_angle(points, T, radians):
    new_points = rotate_by(points, radians)
    return path_distance(new_points, T.points)

# used to rotate the points as we learned in the lecture that they are all in a similar position for calculation
...
# calculates the distance for to sets of points
...
# calculates the distance of to points
def distance(p1, p2):
    dx = p2.x - p1.x
    dy = p2.y - p1.y
    return math.sqrt(dx * dx + dy * dy)

# used to calculate the centroid for rotation
def centroid(points):
    x = 0
    y = 0
...
# used to scale the gestures to a equal size for better recognition 
...
# creates the bounding box for a gesture
